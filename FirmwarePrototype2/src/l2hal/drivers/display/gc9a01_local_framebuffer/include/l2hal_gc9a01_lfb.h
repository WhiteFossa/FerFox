 ...
 * L2HAL_GC9A01_LFB_DISPLAY_WIDTH must be a multiple of this
 */
#define L2HAL_GC9A01_LFB_DIRTY_PIXELS_TRANSMISSION_LENGTH 40

/**
 * Dirty pixels buffer blocks count. Block have length of L2HAL_GC9A01_LFB_DIRTY_PIXELS_TRANSMISSION_LENGTH pixels
 */
#define L2HAL_GC9A01_LFB_DIRTY_PIXELS_BUFFER_LINE_BLOCKS_COUNT (L2HAL_GC9A01_LFB_DISPLAY_WIDTH / L2HAL_GC9A01_LFB_DIRTY_PIXELS_TRANSMISSION_LENGTH)

/**
 * Dirty pixels buffer line size
 */
#define L2HAL_GC9A01_LFB_DIRTY_PIXELS_BUFFER_LINE_SIZE ((L2HAL_GC9A01_LFB_DISPLAY_WIDTH / L2HAL_GC9A01_LFB_DIRTY_PIXELS_TRANSMISSION_LENGTH) * 4)

/**
 * Dirty pixels buffer total size
 */
#define L2HAL_GC9A01_LFB_DIRTY_PIXELS_BUFFER_SIZE (L2HAL_GC9A01_LFB_DIRTY_PIXELS_BUFFER_LINE_SIZE * L2HAL_GC9A01_LFB_DISPLAY_HEIGHT)

enum L2HAL_GC9A01_LFB_Orientation
{
	L2HAL_GC9A01_LFB_ROTATION_0,  /**< ROTATION_0 */
	L2HAL_GC9A01_LFB_ROTATION_90, /**< ROTATION_90 */
	L2HAL_GC9A01_LFB_ROTATION_180,/**< ROTATION_180 */
	L2HAL_GC9A01_LFB_ROTATION_270 /**< ROTATION_270 */
};
